 ...
 * <ul>
 *   <li>{@link org.xtext.smokingtext.diagramclass.diagramClass.impl.DependancyImpl#getName <em>Name</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class DependancyImpl extends MinimalEObjectImpl.Container implements Dependancy
{
  ...
  {
    return DiagramClassPackage.Literals.DEPENDANCY;
  }
  ...
  public void setName(String newName)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, DiagramClassPackage.DEPENDANCY__NAME, oldName, name));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case DiagramClassPackage.DEPENDANCY__NAME:
        return getName();
    }
