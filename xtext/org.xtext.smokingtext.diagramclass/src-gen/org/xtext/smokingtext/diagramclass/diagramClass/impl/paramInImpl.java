...
public class paramInImpl extends MinimalEObjectImpl.Container implements paramIn
{
  ...
  {
    return DiagramClassPackage.Literals.PARAM_IN;
  }
  ...
  public void setName(String newName)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, DiagramClassPackage.PARAM_IN__NAME, oldName, name));
  }
  ...
  public void setType(String newType)
  {
    ...
    type = newType;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, DiagramClassPackage.PARAM_IN__TYPE, oldType, type));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case DiagramClassPackage.PARAM_IN__NAME:
        return getName();
      case DiagramClassPackage.PARAM_IN__TYPE:
        return getType();
    }
