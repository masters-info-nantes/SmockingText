...
public class DiagramClassFactoryImpl extends EFactoryImpl implements DiagramClassFactory
{
  ...
  public static DiagramClassFactory init()
  {
    try
    {
      DiagramClassFactory theDiagramClassFactory = (DiagramClassFactory)EPackage.Registry.INSTANCE.getEFactory("http://www.xtext.org/smokingtext/diagramclass/DiagramClass"); 
