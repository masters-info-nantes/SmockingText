...
public interface paramIn extends EObject
{
   ...
   * @see #setName(String)
   * @see org.xtext.smokingtext.diagramclass.diagramClass.DiagramClassPackage#getparamIn_Name()
   * @model
   * @generated
   */
  String getName();
  ...
  /**
   * Sets the value of the '{@link org.xtext.smokingtext.diagramclass.diagramClass.paramIn#getName <em>Name</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see #setType(String)
   * @see org.xtext.smokingtext.diagramclass.diagramClass.DiagramClassPackage#getparamIn_Type()
   * @model
   * @generated
   */
  String getType();
  ...
  /**
   * Sets the value of the '{@link org.xtext.smokingtext.diagramclass.diagramClass.paramIn#getType <em>Type</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
